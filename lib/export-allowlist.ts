...
export const EXPORT_TABLES: ReadonlyArray<{ table: string; columns: readonly string[] }> = [
  ...
  { table: 'invoices', columns: ['id', 'invoiceNumber', 'patientId', 'branchId', 'visitId', 'treatmentPlanId', 'discountCodeId', 'issueDate', 'dueDate', 'subtotal', 'discountTotal', 'totalAmount', 'paidAmount', 'status', 'notes', 'createdAt'] },
  { table: 'discount_codes', columns: ['id', 'code', 'description', 'discountType', 'discountValue', 'branchId', 'validFrom', 'validUntil', 'maxRedemptions', 'usedCount', 'isActive', 'createdAt'] },
