...
export default function EditRecording() {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        const [recordingResponse, classesResponse] = await Promise.all([
        ...
        setFormData({
          ...
          recordingDateTime: formatForInput(recordingData.recordingDateTime),
  ...
  const handleChange = (e: React.ChangeEvent<HTMLInputElement | HTMLSelectElement>) => {
    ...
    if (name === 'classId') {
      ...
      setFormData(prev => ({
        ...prev,
        classId: value,
        batchId: cls?.class.batchId || prev.batchId,
      }));
      return;
    }
  ...
  return (
    <div className="p-4">
      <h1 className="text-2xl font-bold tracking-tight mb-6">Edit Recording</h1>
            ...
            <div className="space-y-2">
              ...
              {!selected && formData.batchId && (
                <p className="mt-1 text-sm text-amber-600">
                  This recording was created before the Classes module. Pick a class to link it.
                </p>
              )}
            </div>
